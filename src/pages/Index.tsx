  ...
  return (
    <div>
      ...
      <footer className="footer" id="footer">
        <div className="footer__wrapper container">
          <div className="footer-cta">
            ...
            <div className="footer-cta__content">
              <p>Contact us today for a free consultation and quote. We're here to help with all your roofing needs.</p>
          ...
          <div className="footer__logo">RoofFix</div>
          
          <div className="footer-main">
            <div className="footer-main__introduction">
              <p>Professional roofing solutions with over 20 years of experience. Quality craftsmanship you can trust.</p>
              ...
              <ul className="footer-main__contact-list">
                <li>
                  <a href="#">
                    ...
                    <span>123 Roofing Lane, Suite 100</span>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="mailto:info@rooffix.com">
                    <Mail size={18} className="footer-main__contact-icon" />
                    <span>info@rooffix.com</span>
                  </a>
                </li>
                <li>
                  <a href="#">
        ...
        <p className="footer-copyright">© {new Date().getFullYear()} RoofFix. All rights reserved.</p>
      </footer>
    </div>
  );
};
