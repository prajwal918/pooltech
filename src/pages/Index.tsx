          ...
          <nav className="header__nav">
            ...
            <a href="#" className="header__logo">
              <span style={{ fontSize: '24px', fontWeight: 'bold', display: 'flex', alignItems: 'center' }}>
                <span style={{ color: '#ff6525' }}>Pool</span>Tech
              </span>
            </a>
      ...
      <main>
        ...
        <section id="hero" className="hero">
          <div className="hero__bg">
            <div className="hero__bg-top">
              <img src={heroBg} alt="Repairing pool" loading="eager" />
            </div>
          </div>
                  ...
                  <div className="quote-form__row">
                    <div className="quote-form__group">
                      ...
                      <select id="service" required defaultValue="">
                        ...
                        <option value="replacement">Pool renovation</option>
            ...
            <div className="about__info">
              ...
              <div className="about__info-detail slide-up">
                <p className="about__description">
                  PoolTech has built a strong reputation for providing exceptional pool services, handling everything from minor fixes to complex residential projects with care and expertise.
                </p>
        ...
        <section id="service" className="service">
          <div className="service__wrapper container">
            ...
            <div className="service__tile-list">
              {[
                { img: serviceInstallation, title: "Pool installation", desc: "Reliable installation of modern, long-lasting pools designed for strength, efficiency, and curb appeal." },
                { img: serviceRepair, title: "Pool repair", desc: "Fast and dependable repair services for leaks, cracks, and equipment issues to keep your pool functional." },
                { img: serviceReplacement, title: "Pool renovation", desc: "Complete pool renovation with durable materials, improving safety, energy efficiency, and property value." },
                { img: serviceInspection, title: "Pool inspection & maintenance", desc: "Thorough pool checkups and preventative maintenance to spot issues early and extend the life of your pool." }
              ].map((service, index) => (
                <div key={index}>
            ...
            <div className="process__intro slide-up">
              <div className="process__intro-header">
                ...
                <h2 className="process__heading">
                  Our <span className="colored-text">proven</span> pool service process
                </h2>
              </div>
              <div className="process__intro-description">
                <p className="process__description">
                  Our 4-step process keeps pool maintenance simple, with quality work and clear communication at every step, from start to finish.
                </p>
        ...
        <section id="testimonial" className="testimonial">
          <div className="testimonial__wrapper container">
            ...
            <div className="testimonial__list">
              {[
                { name: "Sarah Johnson", location: "Downtown", text: "PoolTech exceeded our expectations! They renovated our entire pool in just two days with minimal disruption. The team was professional, clean, and the quality is outstanding." },
                { name: "Michael Chen", location: "Riverside", text: "After storm damage, I needed urgent repairs. PoolTech responded same-day and had everything fixed within hours. Their emergency service is truly 24/7. Highly recommend!" },
        ...
        <section className="cta">
          <div className="cta__wrapper container">
            <h2 className="cta__heading">Ready to protect your home with a reliable pool?</h2>
            <p className="cta__description">
              Get your free, no-obligation quote today and discover why thousands of homeowners trust PoolTech.
            </p>
        ...
        <div className="footer__wrapper container">
          ...
          <div className="footer-main">
            <div className="footer-main__introduction">
              <p>Professional pool solutions with over 20 years of experience. Quality craftsmanship you can trust.</p>
              ...
              <ul className="footer-main__contact-list">
                <li>
                  <a href="#">
                    ...
                    <span>123 Pool Lane, Suite 100</span>
                  </a>
                </li>
                <li>
